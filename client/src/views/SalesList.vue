            ...
            <table class="table table-bordered"> 
                ...
                <tbody>
                    <tr v-for="(product, i) in productList" :key="i">
                        ...
                        <td>
                            <button type="button" class="btn btn-dark me-1" @click="gotoImageInsert(product.id)">사진등록</button>
                            <button type="button" class="btn btn-dark me-1" @click="gotoUpdate(product.id)">수정</button>
