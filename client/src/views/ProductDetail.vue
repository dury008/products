<template>
    <main class="mt-3">
        <div class="container">
                    ...
                    <div id="carouselExampleIndicators" class="carousel carousel-dark slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div :class="`carousel-item ${i==0?'active':''}`" :key="i" v-for="(pimg, i) in productImage">
                            <img :src="`/download/${this.productId}/${pimg.path}`" class="d-block w-100" alt="...">
                          </div>
                        </div>
                ...
                <div class="col-md-7">
                    <div class="card shadow-sm mt-4">
                        <div class="card-body">
                            ...
                            <h5 class="card-title pt-3 pb-2 border-top">{{getCurrencyFormat(productDetail.product_price)}}원</h5>
            ...
            <div class="row">
                <div class="col-12">
                    <img  class="img-fluid" :src="`/download/${productId}/${productDetail.path}`" alt="">
                </div>
            </div>
        </div>
    </main>
...
export default {
    ...
    methods: {
        ...
        getCurrencyFormat(value) {
            return this.$getCurrencyFormat(value);
        }
    }
}
</script>